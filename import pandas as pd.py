...
for year in years:
    ...
    # Merge all data
    if not yearly_load.empty and not yearly_price.empty and not yearly_load_forecast.empty:
        df = pd.DataFrame({'Load': yearly_load, 'Price': yearly_price, 'LoadForecast': yearly_load_forecast})
