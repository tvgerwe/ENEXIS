...
logging.basicConfig(
    level=logging.INFO,
    format="%(asctime)s - transform_meteo_obs - %(levelname)s - %(message)s"
)
logger = logging.getLogger("transform_meteo_obs")

# === Config ===
PROJECT_ROOT = Path(__file__).resolve().parents[2]
DB_PATH = PROJECT_ROOT / "src" / "data" / "WARP.db"
RAW_TABLE = "raw_meteo_obs"
TRANSFORM_TABLE = "transform_weather_obs"
