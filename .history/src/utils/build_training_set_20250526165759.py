...
def build_training_set_T(train_start, train_end, run_date):
    ...
    try:
        ...
        df_combined = df_combined.sort_values("target_datetime")df_combined = df_combined.sort_values("target_datetime").drop_duplicates("target_datetime")
